...
export const metadata: Metadata = {
  ...
  description:
    "Learn how the Brook Loans 3-step process works. Apply online, call for live underwriting and e-sign your agreement, then receive your funds within 24 hours.",
  alternates: {
...
const STEPS = [
...

  {
    ...
    imageAlt:
      "Friendly Brook Loans underwriting specialist assisting a customer over the phone",
