...
export const FAQS: Faq[] = [
  ...
  },
  {
    ...
    answer: (
      <>
        ...
        maximum of{" "}
        <strong>${LOAN_LIMITS.maxAmount.toLocaleString()}</strong>.
      </>
    ),
  },
  {
    question: "What is the interest rate on a Brook Loan?",
    ...
    answer: (
      <>
        ...
        <strong>fixed {LOAN_LIMITS.minAPR}% Annual Percentage Rate (APR)</strong>
  ...
  },
  {
    ...
    answer: (
      <>
        There is <strong>no origination fee, no application fee, and no
        upfront cost</strong>. There is also no prepayment penalty&mdash;you can
        pay off your loan early at any time.
      </>
    ),
  },
  {
