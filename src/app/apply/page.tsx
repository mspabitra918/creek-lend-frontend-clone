...
export const metadata: Metadata = {
  title: {
    absolute: "Apply for a Personal Loan | Quick Application | Brook Loans",
  },
  description:
    "Start your Brook Loans application today. Borrow up to $10k with a fixed 10% APR. All credit scores accepted. Submit your form and call for instant underwriting.",
