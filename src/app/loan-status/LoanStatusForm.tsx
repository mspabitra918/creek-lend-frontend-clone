...
> = {
  ...
  request_a_call: {
    ...
    description:
      "Urgent action is required. Please call our underwriting team at (747) 208-0334 to discuss your application and next steps.",
  },
  ...
  declined_pb: {
    ...
    description:
      "Your application was declined because the bank account provided is an online-only or prepaid account. Contact us at (747) 208-0334 if you have a traditional checking account you would like to add.",
  },
  declined_hd: {
    label: "Declined HD",
    color: "text-red-700",
  ...
  bank_verification_completed: {
    ...
    description:
      "Call (747) 208-0334 to Move Forward With Your Loan. Your loan is approved, but not ready for funding.",
  },
  funded: {
    label: "Loan Funded",
          ...
          {loan.status === "bank_verification_completed" && (
            <div className="bg-white rounded-2xl shadow-lg p-6 border border-green-200 text-center">
              ...
              <p className="text-base font-semibold text-text-primary mb-2">
                Call (747) 208-0334 to Move Forward With Your Loan
              </p>
