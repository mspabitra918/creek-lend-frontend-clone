...
const TESTIMONIALS: Testimonial[] = [
  {
    ...
    quote:
      "I needed $3,000 for an emergency home repair and my credit isn't perfect. Brook Loans didn't just approve me; they gave me the exact same 10% rate they advertise. The money was in my account the next morning.",
  ...
  },
  {
    ...
    quote:
      "I was tired of variable rates and hidden charges from other online lenders. The Brook Loans process was incredibly straightforward. I borrowed $8,000, and my repayment schedule was crystal clear from day one.",
